...
description: |
  Exploring Decision Tree Variants in `{tidymodels}`.
author: 
...
knitr::include_graphics("~/Documents/Distill_Website/images/tree.jpeg")
```
...
I'd also like to add here that I couldn't have done this post without collaboration with other UO doctoral students Cianna Bedford-Petersen & Brendan Cullen (Psychology PhD program, specifically). Last I checked, they also hosted this exact tutorial on [Brendan's](https://bcullen.rbind.io/post/2020-06-02-tidymodels-decision-tree-learning-in-r/) and [Cianna's](https://ciannabp.com/post/tidymodels-decision-tree-learning-in-r/) websites, so if you liked this, check out some of their work.
