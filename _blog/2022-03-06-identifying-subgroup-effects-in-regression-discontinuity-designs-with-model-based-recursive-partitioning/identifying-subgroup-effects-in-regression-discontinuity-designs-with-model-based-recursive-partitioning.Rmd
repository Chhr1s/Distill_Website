...
$$
\begin{aligned}
    \operatorname{reading\_spring} = \\
    \alpha + \beta_{1}(\operatorname{reading\_fall}) + \beta_{2}(\operatorname{demo\_observed}_{\operatorname{Subgroup}}) + \\
    \beta_{3}(\operatorname{treatment}_{\operatorname{Intervention}}) + \beta_{4}(\operatorname{reading\_fall} \times \operatorname{treatment}_{\operatorname{Intervention}}) + \\
    \beta_{5}(\operatorname{reading\_fall} \times \operatorname{demo\_observed}_{\operatorname{Subgroup}}) + \\
    \beta_{6}(\operatorname{demo\_observed}_{\operatorname{Subgroup}} \times \operatorname{treatment}_{\operatorname{Intervention}}) + \\ \beta_{7}(\operatorname{reading\_fall} \times  \operatorname{demo\_observed}_{\operatorname{Subgroup}} \times \\
...
expand.grid(
  ...
  labs(
    ...
    title = 'Figure 6. Predicted Change in Reading Score for Eligible Students'
    ) +
  geom_density(
    color = 'black', 
    alpha = 0.6, 
