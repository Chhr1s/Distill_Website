---
title: "Simulating Non-Linear Data with Complex Interaction"
description: |
...
1) anyone who wants to follow along with my [APA 2021 Supplemental Material](www.christopherloan.com/blog/apa-2021/)
...
```{r figure 4, layout = "l-body", fig.height=12, fig.width = 16}
figure_1a <-   
  nonlinear_dat %>% 
...
Let's see how GLMM trees act in my [next post](www.christopherloan.com/blog/apa-2021/)
